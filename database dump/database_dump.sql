...
-------------------------------------------------------------
   ...
   ALTER SEQUENCE "SYSTEM"."USUARIOS_SEQ" INCREMENT BY 1;
   ...
   ALTER SEQUENCE "SYSTEM"."PRODUCTOS_SEQ" INCREMENT BY 1;
   ...
   ALTER SEQUENCE "SYSTEM"."ORDENES_SEQ" INCREMENT BY 1;
...
--------------------------------------------------------
 ...
 --------------------------------------------------------
--  Data for Table USUARIOS, PRODUCTOS, ORDENES
-------------------------------------------------------- 
...
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (1,'Pizza pepperoni',4,'Pizza pepperoni',5,'Personal');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (2,'Pizza pepperoni',8,'Pizza pepperoni',7,'Mediana');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (3,'Pizza pepperoni',12,'Pizza pepperoni',10,'Familiar');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (4,'Pizza hawaiana',4,'Pizza hawaiana',5.5,'Personal');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (5,'Pizza hawaiana',8,'Pizza hawaiana',7.5,'Mediana');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (6,'Pizza hawaiana',12,'Pizza hawaiana',11,'Familiar');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (7,'Pizza hawaiana',16,'Pizza hawaiana',15,'Extra Grande');
INSERT INTO SYSTEM.PRODUCTOS (ID_PRODUCTO,NOMBRE_PRODUCTO,CANTIDAD_PORCIONES,DESCRIPCION,PRECIO,"TAMAÑO") VALUES (8,'Pizza pepperoni',16,'Pizza pepperoni',14,'Extra Grande');

INSERT INTO SYSTEM.ORDENES (ID_ORDEN,NOMBRE_CLIENTE,ID_PRODUCTO,CANTIDAD,FECHA_PEDIDO,DIRECCION,COMENTARIOS,ESTADO,USUARIO) VALUES (1,'Samuel Renderos',1,2,to_date('10/01/22','DD/MM/RR'),'San Salvador','San Salvador','Pendiente','login');
INSERT INTO SYSTEM.ORDENES (ID_ORDEN,NOMBRE_CLIENTE,ID_PRODUCTO,CANTIDAD,FECHA_PEDIDO,DIRECCION,COMENTARIOS,ESTADO,USUARIO) VALUES (2,'Samuel Renderos',7,5,to_date('10/01/22','DD/MM/RR'),'San Salvador','San Salvador','Pendiente','login');
INSERT INTO SYSTEM.ORDENES (ID_ORDEN,NOMBRE_CLIENTE,ID_PRODUCTO,CANTIDAD,FECHA_PEDIDO,DIRECCION,COMENTARIOS,ESTADO,USUARIO) VALUES (3,'Samuel Renderos',2,4,to_date('10/01/22','DD/MM/RR'),'San Salvador','San Salvador','Pendiente','login');
INSERT INTO SYSTEM.ORDENES (ID_ORDEN,NOMBRE_CLIENTE,ID_PRODUCTO,CANTIDAD,FECHA_PEDIDO,DIRECCION,COMENTARIOS,ESTADO,USUARIO) VALUES (4,'Samuel Renderos',8,1,to_date('10/01/22','DD/MM/RR'),'San Salvador','San Salvador','Pendiente','login');
INSERT INTO SYSTEM.ORDENES (ID_ORDEN,NOMBRE_CLIENTE,ID_PRODUCTO,CANTIDAD,FECHA_PEDIDO,DIRECCION,COMENTARIOS,ESTADO,USUARIO) VALUES (5,'Samuel Renderos',5,3,to_date('10/01/22','DD/MM/RR'),'San Salvador','San Salvador','Pendiente','login');
